...
/**
 * A fragment representing a single DVD detail screen. This fragment is either contained in a {@link
 * DVDListActivity} in two-pane mode (on tablets) or a {@link DVDDetailActivity} on handsets.
 */
public class DVDDetailFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (mMovie != null) {
            ...
            Picasso.with(this.getActivity()).load(mMovie.posters.original).into(v);
